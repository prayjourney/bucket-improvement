...
public class TransferParam {
    ...
    public static void main(String[] args) {
        ...
        info.put("home", "四川成都");
        ChinesePeople people = ChinesePeople.builder().age(22).name("lee").info(info).build();
    ...
    public static void changePeople(ChinesePeople people){
        Map<String, String> info2 = new HashMap<>();
        info2.put("address", "北京");
        info2.put("home", "四川雅安");
        ChinesePeople people2 = ChinesePeople.builder().age(22).name("lee").info(info2).build();
        people = people2;
